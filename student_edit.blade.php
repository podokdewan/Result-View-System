                      ...
                      <div class="card-body">
                          ...
                          <form class="forms-sample" method="post" action="{{URL::to('/update_student',$student_description_profile->student_id)}}"> 
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control p-input" name="student_id" aria-describedby="emailHelp" value=
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control p-input" name="student_name" aria-describedby="emailHelp" value=
                                  "{{($student_description_profile->student_name)}}">
